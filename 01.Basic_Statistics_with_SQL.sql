...
/* data_interpretation-total number of staff table employee it seems as 1000*/
SELECT COUNT(*) FROM staff;


/* What about gender distribution? */
/* data interpretation- it seems like here is male as compared to the female ratio is higher*/
SELECT gender, COUNT(*) AS total_employees
FROM staff
GROUP BY gender;

/* How many employees in each department */
/* data interpretation-here we could rectify that highest number of employee is carried by the (automotive department) and the lowest (movies) */
...
/*data interpretation-the unique number of department is 22*/
...
/*data interpretation-it shows the max salary as(149929)  and min salary as (40138) */
...
/*data interpretation-their is multiple department with the 'health' with diffrent salary min(43431)  max(145962)*/
...
/* we are creating 3 buckets here with diffrent case*/
